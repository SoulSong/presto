 ...
 */
public class DynamoDbColumnHandle implements ColumnHandle {

    private final String connectorId;
    private final String columnName;
    private final Type columnType;
    private final int ordinalPosition;
    private final DynamoDbColumn dynamoDbColumn;
            ...
            DynamoDbColumn dynamoDbColumn)
    {
        ...
        this.dynamoDbColumn = dynamoDbColumn;
    }
    ...
    @JsonProperty
    public DynamoDbColumn getDynamoDbColumn() {
